...
export default function ReportScreen() {
  ...
  const translateX = useSharedValue(initialTab === "User" ? tabWidth : 0);
  ...
  const renderWarning = () => (
    <View style={styles.warningContainer}>
      ...
      <Text style={styles.warningText}>
        <Text style={styles.warningBold}>False reports</Text> violate our Community Guidelines and may result in account
        suspension. Only report genuine violations.
      </Text>
    </View>
  );
    ...
    if (activeTab === "Listing") {
      return (
        <View style={styles.itemCard}>
          <Image
            source={{
              uri: "https://m.media-amazon.com/images/I/81wgcld4wxL._AC_UF1000,1000_QL80_.jpg",
            }}
        ...
        {labels.map((label, index) => {
          ...
          return (
            <View key={label} style={styles.stepWrapper}>
              ...
              {index < labels.length - 1 && <View style={[styles.stepLine, isCompleted && styles.stepLineCompleted]} />}
            </View>
          );
        })}
      </View>
