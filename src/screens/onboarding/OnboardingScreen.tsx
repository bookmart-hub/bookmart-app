...
import Svg, { Rect, Circle, Path, Ellipse, Polygon, Text as SvgText, G } from 'react-native-svg';
...
const IllustrationBuySell = () => (
    <Svg width={rf(180)} height={rf(140)} viewBox="0 0 180 140">
        ...
        <G transform="translate(45, 30)">
            ...
            <SvgText x="37" y="27" fontSize="18" fontFamily="Montserrat-Bold" fill="#FFFFFF" textAnchor="middle">B</SvgText>
        </G>
...
const IllustrationRequestShare = () => (
    <Svg width={rf(180)} height={rf(140)} viewBox="0 0 180 140">
        ...
        <G transform="translate(30, 20)" >
            ...
            <SvgText x="27.5" y="24" fontSize="12" fontFamily="Manrope-Bold" fill="#008080" textAnchor="middle">Need Info?</SvgText>
        </G>

        {/* Handshake/Agreement checkmark icon */}
        <G transform="translate(35, 75)">
            <Circle cx="18" cy="18" r="18" fill="#10B981" />
            <Path d="M10,18 L15,23 L26,12" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        </G>
    </Svg>
);
...
const IllustrationMapNavigation = () => (
    <Svg width={rf(180)} height={rf(140)} viewBox="0 0 180 140">
        ...
        {/* Navigation Route */}
        <Path d="M60,90 L60,50 L120,50 L120,35" stroke="#008080" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
...
const SLIDES: SlideItem[] = [
    {
        ...
        description: 'Explore verified book listings right inside your college campus or nearby locations. Easily find resources for your upcoming semesters.',
        Illustration: IllustrationBuySell,
    },
    {
        id: 1,
        title: 'Request from Peers',
        description: 'Can’t find the copy you need? Broadcast a book request to your college network and let peers notification ping you when they have it.',
        Illustration: IllustrationRequestShare,
    },
    {
        id: 2,
        title: 'Interactive Map & Routes',
        description: 'Locate physical listings in real-time. Calculate walking distances and fetch driving routes directly to finalize exchanges.',
