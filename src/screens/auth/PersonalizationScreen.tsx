...
import Svg, { Ellipse, Path, Polygon, Rect, Text as SvgText } from "react-native-svg";
...
import { College, getColleges, submitOnboarding } from "@/types/core";
...
const OnboardingHeroIllustration = () => (
  <Svg width={rem(8.125)} height={rem(6.5625)} viewBox="0 0 180 140">
    ...
    <SvgText x="118" y="72" fontSize="32" fontFamily="Montserrat-Bold" fill="#FFFFFF" textAnchor="middle">
      B
    </SvgText>
...
export default function PersonalizationScreen() {
  ...
  const renderRoleIcon = (role: RoleItem) => {
    ...
    return (
      <Ionicons name={role.icon as any} size={rem(1.5)} color={selectedRole === role.id ? COLORS.white : role.color} />
    );
  };
        ...
        >
          ...
          <View style={styles.heroSection}>
            <View style={styles.heroTextContainer}>
              ...
              <Text style={styles.heroSubtitle}>This helps us show you the most relevant books and offers.</Text>
            </View>
          ...
          <View style={styles.cardContainer}>
            <View style={styles.cardHeaderRow}>
              ...
              <View style={styles.cardHeaderTextCol}>
                ...
                <Text style={styles.cardHeaderSubtitle}>This helps us recommend relevant books and resources.</Text>
              </View>
            </View>
              ...
              <View style={styles.collegeSearchBox}>
                ...
                >
                  ...
                  <TextInput
                    ...
                    placeholder={
                      isCollegeRequired ? "Search your college / university" : "Search your college / university"
                    }
                ...
                <Text style={styles.collegeHelpText}>You can skip this if you're not a student or teacher.</Text>
              </View>
            )}
          </View>
          ...
          <View style={styles.cardContainer}>
            ...
            <View style={styles.tipsBox}>
              ...
              <Text style={styles.tipsText}>
                ...
                <Text style={{ fontFamily: FONTS.manrope.bold }}>settings</Text>.
              </Text>
            </View>
          </View>
