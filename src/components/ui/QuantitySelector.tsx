    ...
    <View style={styles.container}>
      <View style={styles.stepperContainer}>
        <TouchableOpacity
          ...
          onPress={onDecrement}
          style={[styles.iconButton, styles.minusButton, isDecrementDisabled && styles.disabledButton]}
        >
        ...
        <TouchableOpacity
          ...
          onPress={onIncrement}
          style={[styles.iconButton, styles.plusButton, isIncrementDisabled && styles.disabledButton]}
        >
