...
const DEFAULT_AUTHORS: AuthorItem[] = [
  ...
  },
  {
    ...
    photoUri: "https://upload.wikimedia.org/wikipedia/commons/f/f8/Bibhutibhushan_Bandopadhyay.jpg",
  ...
  },
  {
    ...
    photoUri: "https://d18x2uyjeekruj.cloudfront.net/wp-content/uploads/2023/11/kazi-islam.jpg",
  ...
  },
  {
    ...
    photoUri: "https://cafedissensuseveryday.com/wp-content/uploads/2023/05/samaresh-majumdar-370x300-1.jpg",
  ...
  },
  {
    ...
    photoUri: "https://upload.wikimedia.org/wikipedia/commons/a/a8/Michael_Madhusudan_Dutta.jpg",
      ...
      <View style={styles.slot}>
        <Animated.View style={[styles.card, containerStyle]}>
          ...
          <View style={styles.details}>
            <Animated.Text style={[styles.authorName, nameStyle]} numberOfLines={2}>
              {item.name}
            </Animated.Text>

            {item.bio ? (
              <Animated.Text style={[styles.authorBio, bioStyle]} numberOfLines={6}>
                {item.bio}
              </Animated.Text>
            ) : null}
  ...
  ({ authors = DEFAULT_AUTHORS, onAuthorPress, onSeeAllPress }) => {
    ...
    const renderItem = useCallback(
      ({ item, index }: { item: AuthorItem & { _key: string }; index: number }) => (
        <AuthorCard item={item} index={index} scrollX={scrollX} onPress={onAuthorPress} />
      ),
    ...
    return (
      <LinearGradient colors={[COLORS.secondary, COLORS.background]} style={styles.section}>
        {/* ── Header ── */}
