    ...
    >
      ...
      <View style={styles.topContainer}>
        <View style={styles.imageContainer}>
          <Image source={{ uri: book.imageUri }} style={styles.image} contentFit="fill" />
        </View>
        ...
        <View style={styles.detailsGrid}>
          <View style={styles.detailItem}>
            ...
            <Text style={styles.detailLabel}>
              Author: <Text style={styles.detailValue}>{book.author || "Unknown"}</Text>
            </Text>
          </View>
          {userLocation && (
            <View style={styles.detailItem}>
              ...
              <Text style={styles.detailLabel}>
                Walk: <Text style={styles.detailValue}>{walkingTime} mins</Text>
              </Text>
            </View>
          )}
        </View>
